...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title='Build your resume in minutes' description='Create a professional resume in just a few clicks, without any design skills.' />


           <div className="flex flex-col md:flex-row items-center gap-10 md:gap-6 mt-10">
              <img
               className="w-full md:w-1/2 max-w-md h-72 md:h-80 object-cover rounded-2xl shadow-lg"
               src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?fm=jpg&q=60&w=1600&auto=format&fit=crop"
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">AI Content Suggestions</h3>
                                <p className="text-sm text-slate-600 max-w-xs">smart bullet-point rewriting.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">passes applicant tracking systems.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">download resumes in one click.</p>
                            </div>
                        </div>
                    </div>
                </div>
