...
const Dashboard = () => {
  ...
  const colors=["#9333ea","#2563eb","#16a34a","#db2777","#ea580c"]
    ...
    <div className='max-w-7xl max-auto px-4 py-8'>
      ...
      {showCreateResume && (
        ...
        <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <button className='w-full py-2 bg-blue-600 text-white rounded hover:big-blue-700 transition-colors'>Create Resume</button>
      ...
      {showUploadResume && (
        ...
        <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <div>
                <label htmlFor="resume-input" className='block text-sm text-slate-700'>
                  Select Resume File
                  <div className='flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-green-500 hover:text-blue-700 cursor-pointer transition-colors'>
                   {resume? (
              ...
              <button disabled={isLoading} className='w-full py-2 bg-blue-600 text-white rounded hover:big-blue-700 transition-colors flex items-center justify-center gap-2'>
       ...
       {editResumeId && (
        ...
        <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <input  onChange={(e) => setTitle(e.target.value)} value={title} type="text" placeholder='Enter resume title' className='w-full px-4 py-2 mb-4 focus:border-blue-600 ring-blue-600' required/>
              <button className='w-full py-2 bg-blue-600 text-white rounded hover:big-blue-700 transition-colors'>Update</button>
